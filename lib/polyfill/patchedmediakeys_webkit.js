...
shaka.polyfill.PatchedMediaKeysWebkit.setMediaKeys = function(mediaKeys) {
  ...
  shaka.log.debug(
    '[NM DEBUG] patchedmediakeys: setMediaKeys: ',
    oldMediaKeys,
    newMediaKeys,
...
shaka.polyfill.PatchedMediaKeysWebkit.MediaKeySystemAccess.prototype.
  ...
  shaka.log.debug('[NM DEBUG] patchedmediakeys: createMediaKeys: ',
    mediaKeys);
...
shaka.polyfill.PatchedMediaKeysWebkit.MediaKeySystemAccess.prototype.
  ...
  shaka.log.debug('[NM DEBUG] Patched Media Keys: this.configuration_: ',
    this.configuration_);
...
shaka.polyfill.PatchedMediaKeysWebkit.MediaKeys.prototype.createSession =
  ...
  shaka.log.debug(
    '[NM DEBUG] patchedmediakeys: createSession media: ',
    media
  );
  ...
  let session = new PatchedMediaKeysWebkit.MediaKeySession(
    ...
    shaka.log.debug(
      '[NM DEBUG] patchedmediakeys: createSession session: ',
      session
    );
...
shaka.polyfill.PatchedMediaKeysWebkit.MediaKeys.prototype.onWebkitNeedKey_ =
  ...
  if (event.initData instanceof ArrayBuffer) {
    encryptedEvent.initData = event.initData;
  } else {
    encryptedEvent.initData = event.initData.buffer;
  }
...
shaka.polyfill.PatchedMediaKeysWebkit.MediaKeySession.prototype.generate_ =
  ...
  try {
    ...
    shaka.log.debug(
      '[NM DEBUG] generateKeyRequestName: ',
      generateKeyRequestName,
      this.keySystem_,
      mangledInitData
    );
  } catch (exception) {
    ...
    const timer = new shaka.util.Timer(() => {
      try {
        ...
        shaka.log.debug(
          '[NM DEBUG] generateKeyRequestName 2: ',
          generateKeyRequestName,
          this.keySystem_,
          mangledInitData
        );
