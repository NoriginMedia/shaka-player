...
describe('StreamUtils', () => {
  ...
  describe('filterVariantsByHeight', () => {
    ...
    it('filters variants by height', () => {
      const variantsByCodecs = StreamUtils.getVariantsByCodecs([
        avc1Variant1080,
        vp9Variant1080,
        vp9Variant2160,
      ]);

      const actual = StreamUtils.filterVariantsByHeight(
          variantsByCodecs
      ).getAll();

      const expected = StreamUtils.getVariantsByCodecs([
        avc1Variant1080,
        vp9Variant1080,
      ]).getAll();
    ...
    describe('findBestCodecs', () => {
      it('returns best codecs', () => {
        const variantsByCodecs = StreamUtils.getVariantsByCodecs([
          avc1Variant1080,
          vp9Variant1080,
          vp9Variant2160,
        ...
        const filteredVariantsByCodecs = StreamUtils.filterVariantsByHeight(
            variantsByCodecs
        );

        const bestCodecs = StreamUtils.findBestCodecs(
  ...
  describe('getGroupVariantCodecs', () => {
    it('returns group of codecs', () => {
      ...
      expect(StreamUtils.getGroupVariantCodecs(variant)).toBe('avc1-mp4a');
    });
    ...
    it('returns group of codecs without audio', () => {
      ...
      expect(StreamUtils.getGroupVariantCodecs(variant)).toBe('avc1-');
    });
    ...
    it('returns group of codecs without video', () => {
      ...
      expect(StreamUtils.getGroupVariantCodecs(variant)).toBe('-mp4a');
    });
  });
});
