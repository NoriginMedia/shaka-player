...
//!! generated by clutz.
// Generated from /data/workspace/shaka-build-push/eigil/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka {
  class Player extends ?_?.clutz.shaka.util.FakeEventTarget implements ?_?.clutz.shaka.util.IDestroyable {
     ...
     */
    addTextTrack (uri : string , language : string , kind : string , mime : string , codec ? : string , label ? : string ) : ?_?.clutz.shaka.extern.Track ;
    /**
     ...
     */
    static probeSupport ( ) : Promise < ?_?.clutz.shaka.extern.SupportType > ;
    /**
...
declare namespace ?_?.clutz.shaka.media {
  ...
  class MetaSegmentIndex extends ?_?.clutz.shaka.media.SegmentIndex implements ?_?.clutz.shaka.util.IReleasable , Iterable < ?_?.clutz.shaka.media.SegmentReference > {
    ...
    release ( ) : any ;
    updateEvery (interval : number , updateCallback : ( ) => ( ?_?.clutz.shaka.media.SegmentReference | null ) [] ) : any ;
  }
}
// Generated from /data/workspace/shaka-build-push/eigil/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.media {
...
declare namespace ?_?.clutz.shaka.media {
  ...
  class SegmentIterator implements Iterator < ?_?.clutz.shaka.media.SegmentReference | null > {
     ...
     * An iterator over a SegmentIndex's references.
     */
    constructor (segmentIndex : ?_?.clutz.shaka.media.SegmentIndex | null , index : number ) ;
...
declare namespace ?_?.clutz.shaka.media {
  ...
  class SegmentReference {
    ...
    constructor (startTime : number , endTime : number , uris : ( ) => string [] , startByte : number , endByte : number | null , initSegmentReference : ?_?.clutz.shaka.media.InitSegmentReference | null , timestampOffset : number , appendWindowStart : number , appendWindowEnd : number ) ;
    /**
     * Returns the offset from the start of the resource to the end of the
...
declare namespace ?_?.clutz.shaka.net {
  ...
  class NetworkingEngine extends ?_?.clutz.shaka.util.FakeEventTarget implements ?_?.clutz.shaka.util.IDestroyable {
     ...
     */
    static makeRequest (uris : string [] , retryParams : ?_?.clutz.shaka.extern.RetryParameters ) : ?_?.clutz.shaka.extern.Request ;
    /**
...
// Generated from /data/workspace/shaka-build-push/eigil/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class SeekBar extends ?_?.clutz.shaka.ui.RangeElement {
...
declare namespace ?_?.clutz.shaka.util {
  class Mp4Parser {
     ...
     * @param partialOkay If true, allow reading partial payloads from some boxes. If the goal is a child box, we can sometimes find it without enough data to find all child boxes.
     */
    parseNext (absStart : number , reader : ?_?.clutz.shaka.util.DataViewReader , partialOkay ? : boolean ) : any ;
    /**
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/awesomplete.js
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/chromecast.js
declare namespace ?_?.clutz {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/ima.js
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/ima.js
declare namespace ?_?.clutz.google.ima.settings {
  function setLocale (locale : string ) : any ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/jwk_set.js
declare namespace ?_?.clutz {
  /**
   * A JSON Web Key.
   */
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/mdl.js
declare namespace ?_?.clutz {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/mediasession.js
declare namespace ?_?.clutz {
  class MediaMetadata {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/mux.js
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/prefixed_eme.js
declare namespace ?_?.clutz {
  class MediaKeyError {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/abortable.js
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/abr_manager.js
declare namespace ?_?.clutz.shaka.extern {
  /**
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/ads.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/error.js
declare namespace ?_?.clutz.shaka.extern {
  interface Error {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/manifest.js
declare namespace ?_?.clutz.shaka.extern {
  /**
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/manifest.js
declare namespace ?_?.clutz.shaka.extern {
  type Manifest = { minBufferTime : number , offlineSessionIds : string [] , presentationTimeline : ?_?.clutz.shaka.media.PresentationTimeline , textStreams : ?_?.clutz.shaka.extern.Stream [] , variants : ?_?.clutz.shaka.extern.Variant [] } ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/manifest.js
declare namespace ?_?.clutz.shaka.extern {
  type Stream = { audioSamplingRate : number | null , bandwidth ? : number , channelsCount : number | null , closedCaptions : Map < string , string > | null , codecs : string , createSegmentIndex : ?_?.clutz.shaka.extern.CreateSegmentIndexFunction , drmInfos : ?_?.clutz.shaka.extern.DrmInfo [] , emsgSchemeIdUris : string [] | null , encrypted : boolean , frameRate ? : number , height ? : number , id : number , keyIds : Set < string > , kind ? : string , label : string | null , language : string , mimeType : string , originalId : string | null , pixelAspectRatio ? : string , primary : boolean , roles : string [] , segmentIndex : ?_?.clutz.shaka.media.SegmentIndex | null , trickModeVideo : any , type : string , width ? : number } ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/manifest.js
declare namespace ?_?.clutz.shaka.extern {
  type Variant = { allowedByApplication : boolean , allowedByKeySystem : boolean , audio : ?_?.clutz.shaka.extern.Stream | null , bandwidth : number , id : number , language : string , primary : boolean , video : ?_?.clutz.shaka.extern.Stream | null } ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/manifest_parser.js
declare namespace ?_?.clutz.shaka.extern {
  /**
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/manifest_parser.js
declare namespace ?_?.clutz.shaka.extern.ManifestParser {
  type PlayerInterface = { filter : (a : ?_?.clutz.shaka.extern.Manifest ) => Promise < any > , makeTextStreamsForClosedCaptions : (a : ?_?.clutz.shaka.extern.Manifest ) => any , networkingEngine : ?_?.clutz.shaka.net.NetworkingEngine , onError : (a : ?_?.clutz.shaka.util.Error ) => any , onEvent : ?_?.clutz.shaka.util.EventManager.ListenerType , onTimelineRegionAdded : (a : ?_?.clutz.shaka.extern.TimelineRegionInfo ) => any } ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/mp4_parser.js
declare namespace ?_?.clutz.shaka.extern {
  type ParsedBox = { flags : number | null , parser : ?_?.clutz.shaka.util.Mp4Parser , partialOkay : boolean , reader : ?_?.clutz.shaka.util.DataViewReader , size : number , start : number , version : number | null } ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
  type ProgressUpdated = (a : number , b : number , c : number ) => any ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
  type Request = { allowCrossSiteCredentials : boolean , body : ArrayBuffer | ArrayBufferView | null , headers : { [ key: string ]: string } , licenseRequestType : string | null , method : string , retryParameters : ?_?.clutz.shaka.extern.RetryParameters , sessionId : string | null , uris : string [] } ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
  /**
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/offline.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/offline.js
declare namespace ?_?.clutz.shaka.extern {
  type StreamDB = { audioSamplingRate : number | null , channelsCount : number | null , closedCaptions : Map < string , string > | null , codecs : string , encrypted : boolean , frameRate ? : number , height : number | null , id : number , keyIds : Set < string > , kind ? : string , label : string | null , language : string , mimeType : string , originalId : string | null , pixelAspectRatio ? : string , primary : boolean , roles : string [] , segments : ?_?.clutz.shaka.extern.SegmentDB [] , type : string , variantIds : number [] , width : number | null } ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/offline_compat_v1.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/offline_compat_v2.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type AbrConfiguration = { bandwidthDowngradeTarget : number , bandwidthUpgradeTarget : number , defaultBandwidthEstimate : number , enabled : boolean , restrictions : ?_?.clutz.shaka.extern.Restrictions , switchInterval : number } ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type DrmConfiguration = { advanced : { [ key: string ]: ?_?.clutz.shaka.extern.AdvancedDrmConfiguration } | null , applyDolbyAudioFix : boolean , clearKeys : { [ key: string ]: string } , delayLicenseRequestUntilPlayed : boolean , initDataTransform ? : (a : Uint8Array , b : string , c : ?_?.clutz.shaka.extern.DrmInfo | null ) => Uint8Array , logLicenseExchange : boolean , retryParameters : ?_?.clutz.shaka.extern.RetryParameters , servers : { [ key: string ]: string } , updateExpirationTime : number } ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type ManifestConfiguration = { availabilityWindowOverride : number , dash : ?_?.clutz.shaka.extern.DashManifestConfiguration , defaultPresentationDelay : number , disableAudio : boolean , disableText : boolean , disableVideo : boolean , hls : ?_?.clutz.shaka.extern.HlsManifestConfiguration , retryParameters : ?_?.clutz.shaka.extern.RetryParameters } ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type OfflineConfiguration = { progressCallback : (a : ?_?.clutz.shaka.extern.StoredContent , b : number ) => any , trackSelectionCallback : (a : ?_?.clutz.shaka.extern.TrackList ) => Promise < ?_?.clutz.shaka.extern.TrackList > , usePersistentLicense : boolean } ;
}
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/shaka/text.js
declare namespace ?_?.clutz.shaka.extern {
  interface Cue {
    /**
     ...
     */
    nestedCues : ?_?.clutz.shaka.extern.Cue [] | null ;
    /**
     * Text opacity.
     */
    opacity : number ;
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/tippy.js
declare namespace ?_?.clutz {
  /**
...
// Generated from /data/workspace/shaka-build-push/eigil/externs/webkitmediakeys.js
declare namespace ?_?.clutz {
...
// Generated from /data/workspace/shaka-build-push/eigil/ui/externs/ui.js
declare namespace ?_?.clutz.shaka.extern {
  /**
