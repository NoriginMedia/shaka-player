...
Changed:
- Build script in build.py now uses SIMPLE option instead of ADVANCED

Bugfixes:
- fix memory leak in timeline segments (dropped in favor of origin changes)
- fix min eviction overflow (dropped in favor of origin changes)
- fix interval float precision when evicting buffer (dropped in favor of origin changes)
